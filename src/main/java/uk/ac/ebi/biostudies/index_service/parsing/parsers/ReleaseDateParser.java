 ...
 * released/public. The extracted timestamp is rounded to day precision using Lucene's DateTools
...
public class ReleaseDateParser implements Parser {
   ...
   * (yyyy-MM-dd). Attempts to read the release time field first; if not present, falls back to
   * the modification time only if the submission is marked as released/public.
   *
