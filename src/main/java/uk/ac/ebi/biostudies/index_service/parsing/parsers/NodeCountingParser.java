...
/**
 * A parser that counts the number of nodes matching one or more JSONPath expressions in a JSON
 * document.
 */
@Component("NodeCountingParser")
public class NodeCountingParser implements Parser {
