...
/**
 * Represents a single search result document returned from a search query.
 * <p>
 * This record encapsulates the core metadata and content of a study or submission
 * that matches the search criteria. All instances are immutable and contain a fixed
 * set of fields that correspond to the indexed document structure.
 * </p>
 *
